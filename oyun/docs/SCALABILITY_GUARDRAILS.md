...
v4.5.5-u4.3.2 kalıcı SQLite/WAL referans deposu, gerçek HTTP istemci adaptörü ve idempotent authority reset sözleşmesi içerir. SQLite üretim ölçek deposu değildir; milyon kullanıcı hedefinde PostgreSQL/shard tabanlı yetkili servis kullanılacak ve local save hiçbir zaman ortak evren otoritesi kabul edilmeyecektir.
