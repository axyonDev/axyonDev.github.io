...
**Sürüm tabanı:** `4.5.6-u4.3.3` · Save şeması `v16`
**Uygulama kaydı:** U4.3.2 ile kaynakta anında kurulum, deterministik ESC/geri iptali ve santral+yakıt+hat zorunluluğu tamamlandı. U4.3.3 ile okunabilir palet maliyetleri, `defenseGrid` tehdit kapısı ve açılır fabrika üretim/güç raporu eklendi. P0 `spatial-sim.js` dikey dilimi 20/20 assertion ile kanıtlandı; henüz ana UI/tick/save akışına bağlı değildir. Sıradaki ana iş P0→P1 entegrasyon köprüsüdür.
...
| **Fabrika _simülasyonu_** (Factorio'nun ruhu) | ⚠️ Canlı motor hâlâ aggregate; ayrı P0 uzaysal çekirdek bant/inserter/buffer/backpressure/graf-güç/tükenmeyi 20/20 testle kanıtladı. | P0 raporu + kod |
