const CACHE = 'axyon-first-orbit-v4-4-u1';
const ASSETS = ['./','./index.html','./encyclopedia.html','./CHANGELOG.md','./css/style.css','./css/encyclopedia.css','./manifest.json','./assets/icon-192.png','./assets/icon-512.png',
  ...
  './src/core/numbers.js','./data/config.js','./src/core/economy.js','./src/core/quests.js','./src/services/save-service.js','./src/ui/toast.js','./src/ui/help-system.js','./src/ui/encyclopedia.js','./src/canvas/factory-canvas.js','./src/ui/ui.js','./src/ui/combat-ui.js','./src/main.js'];
