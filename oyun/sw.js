const CACHE = 'axyon-orbital-ascendancy-v4-5-0-u4';
const ASSETS = ['./','./index.html','./encyclopedia.html','./CHANGELOG.md','./css/style.css','./css/encyclopedia.css','./manifest.json','./assets/icon-192.png','./assets/icon-512.png',
  './data/feature-flags.js','./vendor/break_eternity/break_eternity.min.js','./src/core/economy-number.js','./src/core/lossless-json.js','./src/services/save-migrator-v16.js','./src/services/storage-vault.js',
