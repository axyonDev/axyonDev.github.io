...
(function(global){
  ...
  // U4.3.2 power discipline: the frozen U2 landing-reactor value is historical data only.
  // Runtime starts with no free power; the first generator requires a real line and finite fuel.
  D.firstOrbit.starterPackage.landingReactorPower=0;
