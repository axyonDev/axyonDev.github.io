...
const manifest=JSON.parse(fs.readFileSync(path.join(root,'manifest.json'),'utf8'));assert.strictEqual(manifest.name,'AXYON: Orbital Ascendancy — Command Authority');assert.strictEqual(manifest.version,'4.5.1-u4.1');
