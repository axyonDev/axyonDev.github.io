...
const manifest=JSON.parse(fs.readFileSync(path.join(root,'manifest.json'),'utf8'));assert.strictEqual(manifest.name,'AXYON: Orbital Ascendancy — Factory Intelligence');assert.strictEqual(manifest.version,'4.5.6-u4.3.3');
