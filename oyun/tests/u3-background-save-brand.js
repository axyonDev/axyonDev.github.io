...
const manifest=JSON.parse(fs.readFileSync(path.join(root,'manifest.json'),'utf8'));assert.strictEqual(manifest.name,'AXYON: Orbital Ascendancy — Power Discipline');assert.strictEqual(manifest.version,'4.5.5-u4.3.2');
