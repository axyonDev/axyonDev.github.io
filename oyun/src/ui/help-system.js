...
(function(global){
  ...
  const uiHelp={
    ...
    power:{title:'Güç Şebekesi',icon:'⚡',desc:'Her makine gerçek bir santrale enerji hattıyla bağlanmalıdır. Yakıt yoksa veya hat kopuksa üretim sıfırdır.'},
    ...
    storage:{title:'Depo ve Pazar',icon:'📦',desc:'Stokları yönet. Yerel satış kapalıdır; bütün ticaret Pazar Uydusu üzerinden süreli ve kotalı sevkiyatlarla yürür.'},
    galaxy:{title:'Galaktik Cephe',icon:'🌌',desc:'Sistem tara, gemi ve savunma üret, rakip dünyalarla savaş ve koloniler kur.'},
    infrastructure:{title:'Gezegen Altyapısı',icon:'🏗️',desc:'Yüzey alanı, altyapı, enerji, ısı, bakım, yörünge ve komuta limitlerini yönet; savunma kompleksleri ve cohort birimleri kur.'},
    ...
    localSell:{title:'Yerel Satış Kapalı',icon:'🚫',desc:'First Orbit ekonomisinde yerel satış yoktur. Ürünler yalnızca Pazar Uydusu ve kuruluş sözleşmeleri üzerinden gönderilir.'},
